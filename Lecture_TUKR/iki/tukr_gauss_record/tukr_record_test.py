...
class TUKR:
    def __init__(self, X, K_num, latent_dim, resolution, ramuda, eta, sigma, nb_epoch, meyasu, x_range, basyo,
                 sitaikoto, X1_num, X2_num, X1, X2):  # 引数はヒントになるかも！
        # 引数を用いたselfの宣言
        self.X = X
        ...
        self.name = ['loss', 'loss_mse', 'loss_L2', 'y_zn', 'y_zk', 'y_zk_wire', 'zn1', 'zn2', 'realx', 'realx1',
                     'realx2', 'zk1', 'zk2']
        # 学習過程記録用 historyの初期化
        self.history = {}
