...
STEP = 150
# 観測空間なし
def visualize_history(Y_history, U_history, V_history, error_history, save_gif=False, filename="tmp", zzz=None):
...
def update_graph(epoch, latent_drawer1,latent_drawer2,
